                                 ...
                                 gpointer   user_data)
{
	...
	for (i = 0; i < n_monitors; i++) {
		...
		GreeterConnectionEditorWindow *window = greeter_connection_editor_window_new (monitor, uuid);
...
greeter_network_page_class_init (GreeterNetworkPageClass *klass)
{
	...
	gtk_widget_class_bind_template_child_private (widget_class, GreeterNetworkPage, wired_details_button);
	...
	gtk_widget_class_bind_template_child_private (widget_class, GreeterNetworkPage, no_device_label);
